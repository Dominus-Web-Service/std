...
export class TypedEventEmitter<TEvents extends EventMap> extends EventEmitter {
	 ...
	 * ```
	 */
	public override emit<KEvent extends keyof TEvents>(
		event: KEvent,
		...args: TEvents[KEvent]
	): boolean {
	 ...
	 * ```
	 */
	public override on<KEvent extends keyof TEvents>(
		event: KEvent,
	 ...
	 * ```
	 */
	public override once<KEvent extends keyof TEvents>(
		event: KEvent,
		listener: (...args: TEvents[KEvent]) => void
	): this {
	 ...
	 * ```
	 */
	public override addListener<KEvent extends keyof TEvents>(
		event: KEvent,
		listener: (...args: TEvents[KEvent]) => void
	): this {
		return super.addListener(event as string, listener as (...args: unknown[]) => void);
	}
	 ...
	 * ```
	 */
	public override removeListener<KEvent extends keyof TEvents>(
		event: KEvent,
		listener: (...args: TEvents[KEvent]) => void
	): this {
	 ...
	 * ```
	 */
	public override off<KEvent extends keyof TEvents>(
		event: KEvent,
		listener: (...args: TEvents[KEvent]) => void
	): this {
	 ...
	 * ```
	 */
	public override listeners<KEvent extends keyof TEvents>(
		event: KEvent
	): ((...args: TEvents[KEvent]) => void)[] {
	 ...
	 * ```
	 */
	public override rawListeners<KEvent extends keyof TEvents>(
		event: KEvent
	): ((...args: TEvents[KEvent]) => void)[] {
	 ...
	 * ```
	 */
	public override prependListener<KEvent extends keyof TEvents>(
		event: KEvent,
		listener: (...args: TEvents[KEvent]) => void
	): this {
		return super.prependListener(event as string, listener as (...args: unknown[]) => void);
	}
	 ...
	 * ```
	 */
	public override prependOnceListener<KEvent extends keyof TEvents>(
		event: KEvent,
		listener: (...args: TEvents[KEvent]) => void
	): this {
		return super.prependOnceListener(event as string, listener as (...args: unknown[]) => void);
	}
}
